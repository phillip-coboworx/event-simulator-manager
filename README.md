...
payload:
- changed_field: status,
  cycle_status_code: 0 (NO CONNECTION) | 1 (ON HOLD) | 2 (WARNING) | 3 (ERROR) | 4 (RUNNING),
...
A change-event can have a payload with multiple changed fields, they just need to be each defined as an individual object inside of the payload. 
